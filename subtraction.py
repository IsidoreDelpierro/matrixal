...
if colsA != colsB or rowsA!= rowsB:
    print("For difference (A-B) to be defined number of rows & columns in A must equal number of rows & columns in B respectively")
else:
    print()
...
if colsD != colsE or rowsD!= rowsE:
    print("For difference (D-E) to be defined number of rows & columns in D must equal number of rows & columns in E respectively")
else:
    print()
...
if colsG != colsH or rowsG!= rowsH:
    print("For difference (G-H) to be defined number of rows & columns in G must equal number of rows & columns in H respectively")
else:
    print()
